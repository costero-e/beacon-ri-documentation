...
const AutomatedDeployment = () => {
  ...
  const copyToClipboard = (snippetId: string) => {
    const textToCopy = snippetId === 'cloning-repository'
    ...
    navigator.clipboard
      ...
      .then(() => {
        ...
        setTimeout(() => setCopySuccess(prevState => ({
          ...prevState,
          [snippetId]: false
        })), 1500); // Reset copy success after 1.5 seconds
      })
    ...
    <div className='deploymentContainer'>
      ...
      <div className='codeSnippet'>
        <pre>
          ...
          <button className='copyButtonCode' onClick={() => copyToClipboard('cloning-repository')}>
      ...
      <div className='codeSnippet'>
        <pre>
          ...
          <button className='copyButtonCode' onClick={() => copyToClipboard('execute-start-script')}>
