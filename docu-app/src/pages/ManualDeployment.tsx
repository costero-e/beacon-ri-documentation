...
const ManualDeployment = () => {
  ...
  return (
    <div className='deploymentContainer'>
      ...
      <ul>
        <li>The API will run in http://localhost:5050/api.</li>
        <li>The Beacon UI will run in http://localhost:3000.</li>
        <li>The mongo-express UI will run in http://localhost:8081.</li>
        <li>The Keycloak UI will run in http://localhost:8080/auth.</li>
      </ul>
