...
const CreatingCSVs: React.FC = () => {
  ...
  return (
    <div className="creatingCSVsContainer">
      ...
      <p>
        You will find all the possible headers to be used for each entry type
        (analyses, biosamples, individuals…) in their respective template.csv
        file inside the
        <a
        ...
        . For example, if we go to <i>biosamples.csv</i>, you will see the first
        column header named like <b>biosampleStatus|id</b>.
      </p>
      <p>
        ...
        . The purpose of the pipe (|) is to separate different field names in
        the spec, being the left field the one that contains the field in the
        right.
      </p>
      <p>
      ...
      <div className="codeSnippet">
        <pre>
          <code id="biosample-status">
            ...
            <br />
            &nbsp;&nbsp;"description": "Ontology value from Experimental Factor
            Ontology (EFO) Material Entity term (BFO:0000040). Classification of
            the sample in abnormal sample (EFO:0009655) or reference sample
            (EFO:0009654).",
            <br />
            &nbsp;&nbsp;"examples": [
            <br />
      ...
      <p>
        Being <b>biosampleStatus|id</b> the ontology inside id that belongs to
        biosampleStatus. So, the rows for this biosampleStatus|id column header
        should always have an ontology written, like this:
      </p>
      <div className="codeSnippet">
        <pre>
      ...
      <p>
        In case we add a <b>biosampleStatus|label</b>, then the csv would look
        like this (each row would be a different sample).
      </p>
      <div className="codeSnippet">
        <pre>
      ...
      <ul>
        <li>
          ...
          write data separated with ‘|’.  For example, if you need to write two
          IDs, the structure would be <i>‘HG00001|HG00002’</i>. In addition,
          you’ll need to respect this order for their correlatives in the same
          document. For example, the next row label would need to be:{" "}
          <i> ‘labelforHG00001|labelforHG00002’</i>
        </li>
        <li>
          As the<i>info</i> field for each collection is very generic and can be
          filled with different data, you will need to fill the column data
          directly with JSON type data. In case you are converting variants with
          CSV, for copies and subjects for <i>genomicVariations</i>, JSON data
          is also needed.
        </li>
        <li>
